/**
 * @module plugins/_shared/env-security
 * @description Environment variable security utilities.
 * Shared utility used by vite.config.ts (not part of any specific plugin).
 ...
 * ```typescript
 * // In vite.config.ts
 * import { validateEnvironmentVariables } from '@plugins/utils/env-security'
 *
