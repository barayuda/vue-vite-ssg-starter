/**
 * @module plugins/vite-move-static-html
 * @description Vite plugin to move static HTML files into their own folders with index.html inside.
 *
 * @packageDocumentation
 * This plugin can be published as a standalone npm package: `vite-plugin-move-static-html`
 *
 * @example
...
export function moveStaticHtmlPlugin(): Plugin {
  return {
    ...
    version: '0.0.1',
    closeBundle() {
      // Use closeBundle hook which runs after all bundles are written
      // This is the proper place for post-build file operations
