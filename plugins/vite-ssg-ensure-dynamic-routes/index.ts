/**
 * @module plugins/vite-ssg-ensure-dynamic-routes
 * @description Vite plugin to ensure dynamic routes are generated for ViteSSG.
 *
 * @packageDocumentation
 * This plugin can be published as a standalone npm package: `vite-plugin-ssg-ensure-dynamic-routes`
 */
